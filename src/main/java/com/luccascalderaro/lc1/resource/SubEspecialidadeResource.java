...
public class SubEspecialidadeResource {
	...
	@PutMapping(value = "/{id}")
	public ResponseEntity<Void> update(@Valid @RequestBody SubEspecialidade obj, @PathVariable Integer id) {
		obj.setId(id);
	...
	@GetMapping
	public ResponseEntity<List<SubEspecialidade>> findAll(){
		List<SubEspecialidade> list = service.findAll();
