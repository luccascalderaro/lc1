...
//
		...
		Medico med2 = new Medico(null, "Pedro", "luccasc@hotmail.com", "6566565", "Rua teste 1");

		med2.getTelefone().addAll(Arrays.asList("36337436", "36355689"));

		med2.getSubEspecialidade().addAll(Arrays.asList(sub1, sub3));
...
//		
		...
		Agenda agenda1 = new Agenda(null, med1, new Date(System.currentTimeMillis()), 12, 15, cadAg1,
				StatusCadastroAgenda.ATIVO);
